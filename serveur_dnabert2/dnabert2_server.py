...
# ============ GESTION DES TOKENS ============
# (identique à serveur_grover/grover_server.py)
...
def create_embeddings(
    ...
    le lot dans le modèle et moyenne le dernier hidden state (en ignorant le
    padding) pour obtenir un vecteur par séquence.
    ...
    try:
        ...
        # hidden state directement en position 0 de la sortie. On en fait la
        # moyenne sur les tokens non-paddés pour obtenir un vecteur de taille
        # fixe par séquence, comme pour Nucleotide Transformer et GROVER.
